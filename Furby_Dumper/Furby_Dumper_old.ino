...
//#define MAX_SIZE 2097152   // Full 2MB - MX25L1605D Furbacca
...
void setup() {
  ...
  //SPI.begin(18, 19, 23, 5); // SCK, MISO, MOSI, CS ESP32
  SPI.begin(13, 12, 11, 5); // SCK, MISO, MOSI, CS ESP32S3
